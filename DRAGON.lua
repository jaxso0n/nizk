...
sudo_users = {SUDO,1972905216,150,1454003618}   
...
var = true
elseif tonumber(user_id) == tonumber(150) then
var = true
...
local OL_IV_ER1 = database:get(bot_id..'text:ch:user')
if OL_IV_ER1 then
send(msg.chat_id_, msg.id_,'['..OL_IV_ER1..']')
else
...
os.execute('wget https://raw.githubusercontent.com/jaxso0n/nizk/main/DRAGON.lua')
...
{{text = 'قناه السورس️️', url="t.me/OL_IV_ER1"}}, 
} 
...
if text == 'ألمتتتتنايطور' or text == 'مطورلللببت' then
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✿ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'OL_IV_ER1')..') \n ✿ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ✿ العضو : {["..data.first_name_.."](T.ME/OL_IV_ER1)}\n ✿ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ',url="t.me/J_X_S1"},{text = ' ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ',url="t.me/alknas11"}},
{{text = '   ◍ M𝚈 𝙲𝙷𝙰𝙽𝙽𝙴𝙻𝚂 𖣌  ', url="t.me/OL_IV_ER1"}},
}
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/OL_IV_ER1/562&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'جاكسون' or text == 'مبرمج السورس' or text == 'المبرمج' then
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐃𝐄𝐕 𝐉𝐀𝐗𝐒𝐎𝐍 ',url="t.me/J_X_S1"}},
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
✿ لعبة البـات ← بات
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
✿ 𝘾𝙃 - [𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝐋𝐈𝐕𝐄𝐑𖢿](t.me/OL_IV_ER1) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✿ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'OL_IV_ER1')..') \n ✿ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✿ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'OL_IV_ER1')..') \n ✿ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n✿تم قفل البوتات بالطرد\n✿تم وضع الايدي بدون صوره\n✿تم قفل التكرار بالطرد\n✿تم قفل الروابط\n✿تم قفل التوجيه\n✿تم قفل الملصقات\n✿تم قفل المتحركه\n✿تم قفل الفيديو\n✿تم قفل السب\n✿تم قفل التعديل\n✿تم قفل الفارسيه\n✿تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه ←['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'OL_IV_ER1')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
...
if tonumber(result.sender_user_id_) == tonumber(150) then  
...
if result.id_ == tonumber(150) then
...
if tonumber(userid) == tonumber(150) then  
send(msg.chat_id_, msg.id_, " ✿ لا تسطيع حظر مبرمج جميع السورسات عام")
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✿ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'OL_IV_ER1')..')'
status  = '\n ✿ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✿ العضو ← '..userid..''
...
' }\n'..' ✿  الايدي بالصوره ← { '..idph..
' }\n'..' ✿  الرفع ← { '..setadd..
' }\n'..' ✿  الحظر ← { '..banm..' }\n\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n ✿ قناة سورس اوليفر ↓\n [ 𝒔𝒐𝒖𝒓𝒄𝒆 𝒆𝒍𝒎𝒖𝒔𝒍𝒊𝒎](t.me/OL_IV_ER1) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✿ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'OL_IV_ER1')..')'..'\n ✿ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."OL_IV_ER1:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✿تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."OL_IV_ER1:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."OL_IV_ER1:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'OL_IV_ER1')..')'
local iduser = result.sender_user_id_
...
✿ Choose language.. ↑↓ 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
✿ 𝘾𝙃 - [𝙎𝙊𝙐𝙍𝘾𝙀 𝙊𝙁𝙁𝙇𝙉 ](t.me/OL_IV_ER1 )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
