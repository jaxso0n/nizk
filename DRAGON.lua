...
sudo_users = {SUDO,1972905216,150,160}   
...
var = true
elseif tonumber(user_id) == tonumber(160) then
var = true
...
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙰f𝙰𝚃𝙰𝚁 ', url="t.me/OL_IV_ER1"}}, 
{{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
...
if tonumber(result.sender_user_id_) == tonumber(160) then  
...
if result.id_ == tonumber(160) then
...
if tonumber(userid) == tonumber(160) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مالك السورس عام")
return false 
end
