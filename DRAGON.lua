...
sudo_users = {SUDO,70,1741899314,80,30,50}   
...
if tonumber(user_id) == tonumber(70) then  
var = true
...
if text == 'جاكسنتظاتتتننون' or text == 'المطوتتننر جاهتتكسون' or text == 'محمد مطور السورس' or text =='تيرارارار' then
local Text =[[
...
if text == 'محمد' or text == 'مبرمج السورس' or text == 'محمد مبرمج السورس' or text =='الهقر' then
local Text =[[
...
{
{text = '𝐃𝐞𝐯 ᗰ๐ᏂᗩᗰＥᗪ', url = "https://t.me/JA_XS"},
},
{
{text = '𝑺𝑶𝑼𝑹𝑪𝑬 𝑱𝑨𝑿𝑺𝑶𝑵', url = "https://t.me/J_ax_s_o_N"},
},
...
if text == 'jhh' or text == 'gh' or text == 'يا vvb' or text == 'source' then 
local Text = [[ 
╭──── ● ☆ ● ────╮
☆
𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆   
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '☼︎𝐷𝑒𝑣 𝒋𝒂𝒙𝒔𝒐𝒏☼︎',url="t.me/JAXSO0N"}}, 
{{text = '☼︎𝐷𝑒𝑣 ᗰ๐ᏂᗩᗰＥᗪ ᗩͲᏐᗩ☼︎',url="t.me/JA_XS"}}, 
...
if text == 'jhgghj' or text == 'الbbbbbbnj' or text == 'مادbbnnjkjgxس' or text == 'تيرارارار' then
local Text =[[
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ 𝐓𝐄𝐀𝐒𝐎𝐋  ♬  ❩', url="t.me/Mody_23bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if tonumber(result.sender_user_id_) == tonumber(80) then  
...
if result.id_ == tonumber(80) then
send(msg.chat_id_, msg.id_, " ♲ لا تسطيع حظر مطور السورس عام \n")
return false 
end
...
if tonumber(userid) == tonumber(80) then  
send(msg.chat_id_, msg.id_, " ♲ لا تسطيع حظر مطور السورس عام")
return false 
end
