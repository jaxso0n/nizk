...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 ¹𝐎𝐋𝐈𝐕𝐄𝐑  ¹")  
...
local Keyboard = {
{'𓆩| ıl`O Ｌ Ｉ Ｖ Ｅ Ｒ´lı |𓆪'},
{'نسبه الكره','نسبه الرجوله'},
{'نسبه الحب','نسبه الانوثه'},
{'𓆩| ıl`O Ｌ Ｉ Ｖ Ｅ Ｒ´lı |𓆪'},
{'ايدي','العاب اوليفر','سورس','تغير الايدي'},
{'𓆩| ıl`O Ｌ Ｉ Ｖ Ｅ Ｒ´lı |𓆪'},
...
send(msg.chat_id_, msg.id_,' ◉ اصدار سورس اوليفر { s: 6.7}')
end
if text == 'جاكسون مبرمج السورس' and sudo2(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV Devid](t.me/J_X_S1)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ✤ ⁽𝐽 𝐴 𝑋 𝑆 𝑂 𝑁 ₎ ✤ ', url="t.me/J_X_S1"}}, 
} 
...
if text == 'ch' or text == 'c h' then
local msg_id = msg.id_/2097152/0.5
local Text = [[
 المبرمج ch 
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '  𓌹 ˹𝐶 𝐻 ¹˼ 𓌺 ',url="t.me/J_a_xs_oN "}},}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/J_a_xs_oN &caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'ديغو' or text == "دييغو" then
local msg_id = msg.id_/2097152/0.5
local Text = [[
 المبرمج ديغو
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '  𓌹 ˹𝐷 𝐼 𝐸 𝐺 𝑂 ¹˼ 𓌺 ',url="t.me/JA_XS"}},}
...
{{text = '  𖣘 ⁽𝐽 𝐴 𝑋 𝑆 𝑂 𝑁 ₎ 𖣘 ',url="t.me/J_X_S1"}},
...
local Text = [[
 ◉ اهلا بك في سورس اوليفر الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  ◉ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  𖣘 ⁽𝐽 𝐴 𝑋 𝑆 𝑂 𝑁 ₎ 𖣘 ',url="t.me/J_X_S1"}},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  𖣘 ⁽SＯＵＲＣＥ₎ 𖣘', url="t.me/J_ax_s_o_N"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𖣘⁽𝐶 𝐻 ₎𖣘', url="t.me/J_a_xs_oN"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
◉ خلفيات ← لعرض الميزه
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◉ 𝘾𝙃 - [O Ｌ Ｉ Ｖ Ｅ Ｒ](t.me/J_ax_s_o_N) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
if tonumber(result.sender_user_id_) == tonumber(1449796269) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1449796269) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1449796269) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري نور عنيا🥺🤍](t.me/J_ax_s_o_N)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري الثاني حته مني 😍💚](t.me/J_ax_s_o_N)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور بس الصغنن 🔥♥️](t.me/J_ax_s_o_N)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/J_ax_s_o_N)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه??🤦‍♂️](t.me/J_ax_s_o_N)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/J_ax_s_o_N)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/J_ax_s_o_N)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/J_ax_s_o_N)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مميز ابن ناس 😊 ](t.me/J_ax_s_o_N)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ عضو قميل 🔥♥️ ](t.me/J_ax_s_o_N)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
{
{text = ' 𝚂𝙾𝚄𝚁𝙲𝙴 𝚘𝚕𝚒𝚟𝚎𝚛', url="t.me/J_ax_s_o_N"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'Ｓ๐ＵᎡϹＥ ỌＬᏐＶＥᎡ',url="t.me/J_ax_s_o_N"}},
}
M = math.random(2,29)
local msg_id = msg.id_/2097152/0.5
